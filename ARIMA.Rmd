...
## Portmanteau test
in time serie, Ljung-box test and Box-Pierce test are 2 variances, and they are closely connted.  Ljung-Box $H_0$ says data are independent, $H_a$ is data is serial correlated(auto-correaltion)
